...
BOARD_TILES_INFO = {
    ...
    "Railway2: Chennai Central Station": ["This railway station is one of the busiest in the country and connects Chennai to various parts of India.", "black", 200, 100, [25, 50, 100, 200], None, None],
    ...
    "Railway3: Chatrapathi Shivaji Terminal Station": ["A railway station in Mumbai, Maharashtra known for its impressive Victorian Gothic architecture and being one of the busiest railway stations in India.", "Railway", 200, 100, [25, 50, 100, 200], 0, 0],
    ...
    "Railway4: Howrah Station": ["A railway station in Kolkata, West Bengal known for being one of the largest and busiest railway stations in India.", "Railway", 200, 100, [25, 50, 100, 200], 0, 0],
